      ...
      <Router>
        <div>
          ...
          <Routes>
            ...
            <Route exact path="/general" element={<NewsContainer setProgress={this.setProgress} apiKey={this.apiKey} key="general" pageSize={this.pageSize} country="in" category="general" />} />
